namespace TicTacToe {
    public class GameReferee {
        ...
        private bool hasColumnWin(char c) {
        ...
        private bool hasDiagonalWin(char c) {
        ...
        public bool playerHasWon(char c) {
            return hasRowWin(c) || hasColumnWin(c) || hasDiagonalWin(c);
        }
    }
}